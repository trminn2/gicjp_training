...
public abstract class BaseController {
	 ...
	 * @return the message
	 */
	protected final String getMessage(@NonNull String messageCode) {
	 ...
	 * @return String
	 */
	protected final String redirectURL(@NonNull String url) {
	 ...
	 * @return String
	 */
	protected final String redirectURL(@NonNull String param, @NonNull String url) {
