...
public interface M07_Service {
	 ...
	 * @return Collection
	 */
	Collection<EmpGroup> findAllGroup(@NonNull M07_EmpInfoCreateModel m07Model);
	 ...
	 * @return Collection
	 */
	Collection<Department> findAllDepartment(@NonNull M07_EmpInfoCreateModel m07Model);
